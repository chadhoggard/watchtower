...
export default function StatusPage() {
  ...
  if (loading) {
    return <div className="text-gray-500 py-10 text-center">Loading status...</div>;
  }
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className={`${overallColor} rounded-lg p-6 text-white text-center mb-8`}>
        ...
        {data.monitors.map((monitor, i) => (
          ...
          >
            <div>
              ...
              <p className="text-sm text-gray-500">{monitor.uptime_percentage}% uptime (24h)</p>
            </div>
