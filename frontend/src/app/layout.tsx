        ...
        <nav className="bg-white border-b border-gray-200 px-6 py-4">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <div className="flex gap-6">
              ...
              <a href="/monitors/create" className="text-gray-600 hover:text-gray-900 font-medium">Add Monitor</a>
              <a href="/status" className="text-gray-600 hover:text-gray-900 font-medium">Status Page</a>
            </div>
          </div>
        </nav>
