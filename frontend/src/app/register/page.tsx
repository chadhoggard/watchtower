...
export default function RegisterPage() {
    ...
    try {
      ...
      setError(
        message === "Registration is closed"
          ? "Registration is closed because this Watchtower instance already has an account. Please sign in instead."
          : message,
      );
    } finally {
      setLoading(false);
  ...
  return (
    <div className="min-h-[calc(100vh-5rem)] bg-gray-50 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-sm">
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
          <h1 className="text-lg font-bold text-gray-900 mb-1">Create account</h1>
          <p className="text-sm text-gray-500 mb-6">Register the first Watchtower admin user</p>
          {error && (
